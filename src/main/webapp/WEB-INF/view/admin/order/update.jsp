                                            ...
                                            <form:form method="post" action="/admin/order/update" class="row"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="<fmt:formatNumber value='${singleOrder.totalPrice}' type='number' groupingUsed='true' maxFractionDigits='0'/> đ" >
                                                </div>


                                                <div class="col-md-6">
                                                    <label class="form-label">Tên người order:</label>
                                                    <input type="text" class="form-control" value="${singleOrder.user.fullname}" disabled />
                                                </div>
                                                </div>
